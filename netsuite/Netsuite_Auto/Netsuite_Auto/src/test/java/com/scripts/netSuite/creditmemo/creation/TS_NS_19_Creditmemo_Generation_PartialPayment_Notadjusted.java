package com.scripts.netSuite.creditmemo.creation;
...
public class TS_NS_19_Creditmemo_Generation_PartialPayment_Notadjusted extends BaseReport  {
	...
	//==============>
		...
		public void test() throws FileNotFoundException, IOException {
			TestDataPath = System.getProperty("user.dir") + "\\Data\\NetSuiteTestData_CreditmemoGeneration.xlsx";
		...
		@Test
		public void TS_NS_19_Creditmemo_Generation_PartialPayment_Notadjusted() throws InterruptedException
		{
			 ...
			 basetest.test.info("<span style='font-weight:bold;color:green'>'"+ XLTestData.get("TestCaseID")+ " Execution started"+"'</span>");
			//Launch URL
			...
			//Login Application
				...
				//Invoice rebill
				oSalesOrderNetsuite.Creditmemo_Generation(driver, XLTestData, basetest);

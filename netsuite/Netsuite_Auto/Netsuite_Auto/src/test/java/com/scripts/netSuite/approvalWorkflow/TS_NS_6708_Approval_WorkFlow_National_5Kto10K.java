...
public class TS_NS_6708_Approval_WorkFlow_National_5Kto10K extends BaseReport {
	
	private BaseTest basetest;
	public static Excel_Reader excelReader;
	public static int i=6708;
	...
	@Test
	public void TS_NS_6708_Approval_WorkFlow_National_5Kto10K() throws InterruptedException
	{
       ...
       driver = oLoginPage.LaunchNetSuiteApp(XLTestData, "", basetest);
		//Login Application
			...
			//Approval Work Flow
			oSalesOrderNetsuite.approvalWorkFlow_above5k(driver, XLTestData, basetest);

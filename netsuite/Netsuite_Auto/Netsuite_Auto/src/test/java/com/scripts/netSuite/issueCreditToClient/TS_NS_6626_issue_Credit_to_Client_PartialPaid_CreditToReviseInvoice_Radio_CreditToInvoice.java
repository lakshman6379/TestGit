...
public class TS_NS_6626_issue_Credit_to_Client_PartialPaid_CreditToReviseInvoice_Radio_CreditToInvoice extends BaseReport {
	
	private BaseTest basetest;
	public static Excel_Reader excelReader;
	public static int i=6626;;
	...
	@Test
	public void TS_NS_6626_issue_Credit_to_Client_PartialPaid_CreditToReviseInvoice_Radio_CreditToInvoice() throws InterruptedException
	{
		...
		//Login Application
			...
			oSalesOrderNetsuite.issue_Credit_to_Client_PartialPaid_CreditToReviseInvoice_PaymentApplied(driver, XLTestData, basetest);

...
public class TS_NS_6632_CreditOnly_Radio_Issue_credit_to_client extends BaseReport {
	
	private BaseTest basetest;
	public static Excel_Reader excelReader;
	public static int i=6632;
	...
	@Test
	public void TS_NS_6632_CreditOnly_Radio_Issue_credit_to_client() throws InterruptedException
	{
	
		 basetest.test = basetest.extent.createTest(XLTestData.get("TestCaseID")+"_"+XLTestData.get("TestFlow").toString(), XLTestData.get("TestCaseID")+"_"+XLTestData.get("TestFlow").toString());
		...
		//Login Application
			...
			oSalesOrderNetsuite.issueCreditToClient_PartialPaid_Digital(driver, XLTestData, basetest);
